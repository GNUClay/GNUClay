...
namespace GnuClayUnity3DHost.BaseHostSystem.Internal.RemoteLoggingSystem
{
    public class RemoteLogger: BaseHostLoggedComponent, ILoggingMessagesInRemoteLogger
    {
        public RemoteLogger(CommonContextOfBaseHost context, ILog logger)
            : base(context, logger)
        {
        }
