...
namespace TSTConsoleWorkBench.TextCGParser
{
    ...
    public class TextCGParserRunner
    {
        ...
        private void CreateTargetNode(CGNode cn)
        {
            ...
            NLog.LogManager.GetCurrentClassLogger().Info($"CreateTargetNode rootNode = {DotConverter.ConvertToString(rootNode)}");

            NLog.LogManager.GetCurrentClassLogger().Info($"CreateTargetNode rootNode.IsEquals(cn) = {rootNode.IsEquals(cn, null)}");
        }
