...
namespace GnuClay.Engine.LogicalStorage.CommonData
{
    ...
    /// </summary>
    public class ExternalVarResultItem : IVarResultItem, IToStringData
    {
        /// <summary>
    ...
    /// </summary>
    public class ExternalSelectResultItem : ISelectResultItem, IToStringData
    {
        /// <summary>
        ...
        /// </summary>
        public List<IVarResultItem> Params { get; set; } = new List<IVarResultItem>();
    ...
    /// </summary>
    public class ExternalSelectResult : ISelectResult, IToStringData
    {
        /// <summary>
        ...
        /// </summary>
        public List<ISelectResultItem> Items { get; set; } = new List<ISelectResultItem>();
