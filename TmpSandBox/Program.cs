...
using GnuClay.Core.Implementations.CoreLoaderFromSharedLibrary;
...
namespace TmpSandBox
{
    class Program
    {
        ...
        private static void TSTSerializableHelper()
        {
            ...
            var fullName = storage.FullFileName;
            ...
            //            var typeFactory = new TstClassTypeFactory();
        ...
        private static void TSTCore()
        {
            ...
            var proxyCoreLoaderFromSharedLibraryComponent = new ProxyCoreLoaderFromSharedLibraryComponent(context);
        ...
        */
        ...
        private static void TSTParsingOfManyTenses()
        {
            ...
            runner.ConvertToConceptualGraph = true;
            runner.Run();
